...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleCancelada(ReservaCanceladaException ex) {
        return buildError(HttpStatus.CONFLICT, ex.getMessage());
    }

    @ExceptionHandler(DatosReservaInvalidosException.class)
    public ResponseEntity<Map<String, Object>> handleDatosInvalidos(DatosReservaInvalidosException ex) {
    ...
    public ResponseEntity<Map<String, Object>> handleValidation(MethodArgumentNotValidException ex) {
        ...
        body.put("error", "Validación fallida — verifique los campos obligatorios");
